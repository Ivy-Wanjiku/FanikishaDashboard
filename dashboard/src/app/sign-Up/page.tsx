...
const SignUp = () => {
  ...
  return (
    <div className="flex justify-center items-center lg:px-2   xl:px-4 lg:flex items-centre 2xl:px-6 2xl:min-h-screen lg:min-h-3.5 bg-white-100 font-work sans">
      <div className="2xl:w-[1250px] lg:w-[700px] flex justify-between items-center">
        ...
        >
          <h1 className="2xl:text-[50px]  2xl:mb-4 lg:mb-[-5px] xl:mb-[4px] text-blue-500 font-bold text-center lg:text-[40px] xl:text-[48px] 2xl:mt-[-30px]">
            Sign Up
          </h1>
          ...
          <div className="mb-1 flex flex-col items-center">
            <label
              htmlFor="First_name"
              className="2xl:text-[22px]  lg:text-[14px]  xl:text-[20px] text-black-700 2xl:ml-[-630px] lg:ml-[-290px] xl:ml-[-300px]"
            >
              First Name:
            </label>
            <input
          ...
          <div className="2xl:mb-1 flex flex-col items-center">
            <label
              htmlFor="Last_name"
              className="2xl:text-[22px] xl:text-[20px] text-black-700 2xl:ml-[-630px] lg:ml-[-290px] lg:text-[14px] xl:ml-[-300px]"
            >
              Last Name:
            </label>
            <input
          ...
          <div className="mb-1 flex flex-col items-center">
            <label
              htmlFor="Role"
              className="2xl:text-[22px] text-black-700 lg:ml-[-330px] lg:text-[14px] xl:text-[20px] xl:ml-[-300px] 2xl:ml-[-690px]"
            >
              Role:
            </label>
            <select
          ...
          <div className="2xl:mb-1 flex flex-col items-center">
            <label
              htmlFor="Email"
              className="2xl:text-[22px] text-black-700 lg:ml-[-330px] lg:text-[14px] xl:text-[20px] 2xl:ml-[-690px]"
            >
              Email:
            </label>
            <input
          ...
          <div className="2xl:mb-1 relative flex flex-col items-center">
            <label
              htmlFor="Password"
              className="2xl:text-[22px] text-black-700 lg:ml-[-290px] lg:text-[14px] xl:text-[20px] 2xl:ml-[-650px]"
            >
              Password:
            </label>
            <input
          ...
          <div className="2xl:mb-1 flex flex-col items-center relative">
            <label
              ...
              className="2xl:text-[22px] text-black-700 lg:ml-[-240px] lg:text-[14px] xl:text-[20px] 2xl:ml-[-550px]"
            >
              Confirm Password:
            </label>
            <input
